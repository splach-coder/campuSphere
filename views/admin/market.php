...
<head>
    ...
    <link rel="stylesheet" href="../../public/css/marketAdmin.css">
    ...
    <!-- js files -->
    <script defer src="../../public/js/adminMarket.js"></script>
...
<body>
    ...
    <section class="home">
        <select id="date-filter">
            ...
            <option value="3days">3 Days Earlier</option>
            <option value="5days">5 Days Earlier</option>
    ...
    <?php include '../templates/product-admin-viewer.php' ?>
    <?php include '../templates/blockPost.php' ?>
</body>
